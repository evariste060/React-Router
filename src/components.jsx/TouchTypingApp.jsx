...
const isCorrect = sentence[currentIndex] === userInput[currentIndex] 
const isWrong = sentence[currentIndex] !== userInput[currentIndex]; 

const handleInputChange = (e) => {
    let newValue = e.target.value;
    //if(userInput.length > sentence.length) return;
   setUserInput(newValue);
   setIsCompleted(newValue === sentence);  
};
